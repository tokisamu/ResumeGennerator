<template>
	<div class="work">
		<FormTitle>工作经历</FormTitle>
		<WorkGroup v-for="idx in groupController" v-if="isDeleted(idx)" v-bind:id="idx" ref="work" v-on:delete-self="deleteGroup"></WorkGroup>
...
<script>
import WorkGroup from './formgroup/WorkGroup';
