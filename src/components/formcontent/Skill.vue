<template>
	<div class="skill">
		<FormTitle>技能特长</FormTitle>
		<SkillGroup v-for="idx in groupController" v-if="isDeleted(idx)" v-bind:id="idx" ref="work" v-on:delete-self="deleteGroup"></SkillGroup>
...
<script>
import SkillGroup from './formgroup/SkillGroup';
